...
- [Using /oss](guides/using-oss.md) — all 8 scenarios in depth with examples
...
- [Skills](reference/skills.md) — all 5 skills with trigger phrases
- [Hooks](reference/hooks.md) — guardrail registration and full deny/allow matrix
- [Scenarios](reference/scenarios.md) — canonical 8-scenario table with full detail
